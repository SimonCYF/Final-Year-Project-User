...
public class HorizontalViewAdapterCandidate extends RecyclerView.Adapter<HorizontalViewAdapterCandidate.ViewHolder>{
    ...
    public HorizontalViewAdapterCandidate(Context context, ArrayList<String> name, ArrayList<String> image, ArrayList<String> state, ArrayList<String> propaganda, ArrayList<String> party){
        mName = name;
        mImage = image;
        mContext = context;
        mState = state;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_swipe_horizontal_candidate, parent, false);
        return new ViewHolder(view);
    }

    //Bind The Widgets Together
    @Override
    public void onBindViewHolder(@NonNull HorizontalViewAdapterCandidate.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            Party = itemView.findViewById(R.id.horizontalCandidateParty);
