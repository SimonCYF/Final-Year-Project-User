package com.example.finalyearprojectuser.viewinfo;
...
import com.example.finalyearprojectuser.recycleviewadapter.HorizontalViewAdapterCandidate;
import com.example.finalyearprojectuser.party.ViewParty;
import com.example.finalyearprojectuser.recycleviewadapter.HorizontalViewAdapterSenator;
...
public class ViewCandidate extends AppCompatActivity implements CheckNetwork.ReceiverListener {
    ...
    private boolean checkCandidateStateStatus = false;
    ...
    private DatabaseReference reference, senatorReference;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Linking
        textView = findViewById(R.id.resultsCandidateChange);
        spinner = findViewById(R.id.candidateSpinner);
        decisionSwitch = findViewById(R.id.viewCandidateSwitch);

        Toast.makeText(ViewCandidate.this,"Default Candidate View", Toast.LENGTH_LONG).show();

        //Linking Edit Spinner
        stateList = new ArrayAdapter<String>(ViewCandidate.this, android.R.layout.simple_spinner_item, state);
        ...
        spinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ViewCandidate.this,selectedState,Toast.LENGTH_SHORT).show();
    ...
    private void switchCase(int position) {
        switch (position) {
            case 0:
                intent = new Intent(ViewCandidate.this, CheckStatus.class);
                break;

            case 1:
                intent = new Intent(ViewCandidate.this, ViewCandidate.class);
                break;

            case 2:
                intent = new Intent(ViewCandidate.this, ViewParty.class);
                break;

            case 3:
                intent = new Intent(ViewCandidate.this, ViewRealTimeResults.class);
                break;

            case 4:
                intent = new Intent(ViewCandidate.this, ViewPDF.class);
                break;

            case 5:
                intent = new Intent(ViewCandidate.this, MapsFragment.class);
                break;

            case 6:
                intent = new Intent(ViewCandidate.this, Profile.class);
                break;
        }
    ...
    private void getAllData(){
        ...
        if(selectedState.equals("DEFAULT") && integer == 1) {
            ...
            checkCandidateStateStatus = true;
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for(DataSnapshot data: snapshot.getChildren()) {
                        ...
                        if(checkCandidateStateStatus == true) {
                            if (state_txt.equals(selectedState)) {
                ...
                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(ViewCandidate.this, "Fail To Obtain Data " + error, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void initRecycleViewForGetCandidate(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recycleViewForCandidate);
        recyclerView.setLayoutManager(layoutManager);
        HorizontalViewAdapterCandidate adapter = new HorizontalViewAdapterCandidate(this, candidateName, candidateImage, candidateState, candidatePropaganda, candidateParty);
    ...
    private void initRecycleViewForGetSenator(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recycleViewForCandidate);
        recyclerView.setLayoutManager(layoutManager);
        HorizontalViewAdapterSenator adapter= new HorizontalViewAdapterSenator(this, senatorName, senatorImage, senatorState, senatorPostcode);
        recyclerView.setAdapter(adapter);
    }
